...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
  <div className="relative mx-auto w-full">
	<a href="#" className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
      ...
      <div className="h-full">
        <img src="https://hips.hearstapps.com/hmg-prod/images/bristow-mews-coach-house-exterior-1676468203.jpg" alt="" className=""  />
      </div>
		  </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
		...
		<div className="mt-4">
		  <h2 className="font-medium text-base md:text-lg text-green-900 line-clamp-1" title="New York">
			Statue of Liberty
		  </h2>
		  <p className="mt-2 text-sm text-green-900 line-clamp-1" title="New York, NY 10004, United States">
